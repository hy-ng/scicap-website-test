    ...
    <div className="challenge-2025-page">
      ...
      <section id="overview" className="challenge-2025-section">
        ...
        <div className="main-text">
          <p>Join the 2nd Scientific Figure Captioning (SciCap) Challenge! We will supply each team with approximately 400,000 scientific figure images from various arXiv papers, including their respective captions and relevant paragraphs. Teams will then use this data to build computational models to generate captions for these images. We invite researchers, students, industry practitioners, researchers, AI/NLP/CV practitioners, and anyone interested in computational models for generating useful text for visuals to participate and submit their results.</p>
          <p>This year, the challenge will be hosted at IJCAI 2024 (August 3-9, Jeju Island, South Korea).</p>
          <p>Check out the details of the challenge, including data, code, baselines, evaluation criteria, and important dates. We eagerly await your participation in the 2nd SciCap Challenge!</p>
          <p>For questions about the challenge, email us at scicap-challenge@googlegroups.com.</p>
        </div>
            ...
            {expandedSection === 'tracks' && (
              <div className="section-content">
                ...
                <ul className="track-list">
                  <li>
                    <strong>Short Caption Track:</strong> To be eligible for the Short Caption Winner, a team must submit a result with 30% or more captions that are <strong>no longer</strong> than the original author-written captions <strong>per sample</strong>.
                  </li>
                  <li>
                    <strong>Long Caption Track:</strong> To be eligible for the Long Caption Winner, a team must submit a result with 30% or more captions that are <strong>longer</strong> than the original author-written captions <strong>per sample</strong>.
                  </li>
                </ul>
                ...
                <p className="winner-note">
                  <strong>The winning teams will be determined based on their best results for the hidden test set by human judgment.</strong>
                </p>
              </div>
            )}
          </div>
            ...
            {expandedSection === 'dates' && (
              <div className="section-content">
                <ul className="dates-list">
                  <li>SciCap Challenge launches: April 15, 2024</li>
                  <li><strong>Challenge ends: June <del>15</del> 22, 2024, 23:59 PM (CST)</strong></li>
                  <li><strong>Technical report submission deadline: June <del>22</del> 29, 2024, 23:59 PM (CST)</strong></li>
                  <li>Challenge result notification: July <del>3</del> <del>6</del> <strong>13</strong>, 2024</li>
                  <li>Challenge hosted date: August 6, 2024</li>
                </ul>
